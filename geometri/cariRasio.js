document.getElementById('form-rasio').addEventListener('submit',
    function(event) {
    ...
    let history = JSON.parse(localStorage.getItem('history_cariRasio')) || [];
    history.push(`U1: ${u1}, U2: ${u2}, Beda: ${beda}`);
    localStorage.setItem('history_cariRasio', JSON.stringify(history));
});